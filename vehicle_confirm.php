...
if ($_SESSION["autehtification_success"]){
	...
	if (isset($_POST["id"])){
		$rows=array("marka","model","rik","color","registration_number","owner","owner_phone","owner_address","user");
		$user=$_SESSION["name"];
		...
		$values=array($marka,$model,$rik,$color,$registration_number,$owner,$owner_phone,$owner_address,$user);
